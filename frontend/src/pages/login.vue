...
const handleLogin = async () => {
  try {
    // Se mantiene la lógica de tu aplicación
...
/* Fuerza el color de la etiqueta y los iconos */
...
/* Opcional: Para el texto que el usuario escribe */
.login-card .v-field__input {
  color: white;
}

/* Opcional: Para mantener la opacidad en la etiqueta */
.login-card .v-field__label {
  opacity: 0.8;
}
.login-card {
